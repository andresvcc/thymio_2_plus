...
# VPL3 Interface Documentation iOS
...
To integrate the VPL3 interface into the Thymio Suite Mobile app, the web resources of this interface are stored within the `assets/webroot/vpl3` directory. These resources are then served via a static server within a WebView, enabling the execution of a web page inside the mobile application.

### Initial Configuration for WebView

The WebView that hosts the VPL3 requires certain initial configurations to function properly:
...
```
http://127.0.0.1:3000/vpl3/index.html?robot=thymio-tdm&role=teacher&uilanguage=fr#uuid={d768ed1a-5831-425a-89a0-50d10f8c1a4c}&w=ws://127.0.0.1:8597&pass=CX87IR
```
