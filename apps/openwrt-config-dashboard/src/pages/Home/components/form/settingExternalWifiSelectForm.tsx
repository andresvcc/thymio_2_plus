...
export const SettingExternalWifiForm = ({ topologyData }: { topologyData: TopologyData }) => {
    ...
    <>
      ...
      >
        <div style={{ fontWeight: 'bold', fontSize: '1.1rem', marginBottom: '0.5rem' }}>
          {t('common_online_wireless_settings')}
        </div>
      </div>
      <br />
      ...
      <ContainerSaveButton>
        ...
        >
          <Box sx={style}>
            ...
            <div style={{ width: '100%', padding: '4rem 0rem', display: wizardStep !== 1 ? 'none' : 'block' }}>
              {networks.length === 0 ? (
                <>
                  <Icon
                    name="router"
                ...
                <>
                  <Table
                    ...
                    columns={[
                      ...
                      { key: 'signal', label: 'Signal', render: (value) => `${dbmToSignalQuality(value).toFixed(0)}%` },
                      { key: 'channel', label: '', render: (value) => <SaveButton>Connect</SaveButton> },
                    ]}
                    data={networks
            ...
            >
              <Form onSubmit={onSave}>
                ...
                {tempValues.securityType === 'wpa-eap' ? (
                  <FormGroup>
